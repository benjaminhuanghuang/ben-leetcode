 ...
 */
public class LC_0826_MostProfitAssigningWork {
    /*
    ...
    Time Complexity: O(Nlog N + Qlog Q), where NN is the number of jobs, and QQ is the number of people.
    Space Complexity: O(N)O(N), the additional space used by jobs.
